...
def initialize_community_cards():
    ...
    out_jail = c_def.Fortune("Free of jail", "This card may be kept until needed or sold/traded.", True,
                             False, False, 0, 0)
    go_go = c_def.Fortune("Advance to Go", "Collect $200", True, False, True, 0, 200)
